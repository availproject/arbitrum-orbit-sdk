...
//
// IMAGE: avail-nitro-node:v2.2.1-upstream-v3.2.1-arm64v8
// TIMESTAMP: 2024-11-27T13:41:33.160Z
//
// ---
...
export type NodeConfig = {
  ...
  'execution'?: {
    'caching'?: {
      ...
      'state-scheme'?: string;
      /** initialized stylus programs to keep in LRU cache (default 256) */
      'stylus-lru-cache'?: number;
  ...
  'init'?: {
    ...
    /** the number of threads to use when pruning (default 10) */
  ...
  'node'?: {
    'avail'?: {
      /** Avail chain account app-id (default 1) */
      'app-id'?: number;
      /** Avail chain API offered over the WS-RPC interface (default "wss://turing-rpc.avail.so/ws") */
      'avail-api-url'?: string;
      'avail-bridge-config'?: {
        /** ArbSepolia api offered over the WS-RPC interface (default "wss://sepolia-rollup.arbitrum.io/rpc") */
        'arbsepolia-rpc'?: string;
        /** Avail bridge api offered over the HTTP-RPC interface (default "https://turing-bridge-api.fra.avail.so/") */
        'avail-bridge-api-url'?: string;
        /** vectorx contract address for event notification (default "0xA712dfec48AF3a78419A8FF90fE8f97Ae74680F0") */
        'vectorx-address'?: string;
      };
      /** enable AvailDA as Data Availability Layer */
      'enable'?: boolean;
      'fallback-s3-service-config'?: {
        ...
        /** S3 bucket */
        'bucket'?: string;
        /** discard data after its expiry timeout */
        'discard-after-timeout'?: boolean;
        /** enable storage/retrieval of sequencer batch data from an AWS S3 bucket */
        'enable'?: boolean;
      ...
      /** Avail chain wallet seed */
      'seed'?: string;
      /** timeout for batch inclusion on block finalisation over Avail chain (default 1m40s) */
      'timeout'?: string;
    };
    'batch-poster'?: {
      ...
      /** maximum 4844 blob enabled batch size (default 388144) */
    ...
    'block-validator'?: {
      ...
      'redis-validation-client-config'?: {
        ...
        'name'?: string;
        'producer-config'?: {
          /** interval in which producer checks pending messages whether consumer processing them is inactive (default 1s) */
          'check-pending-interval'?: string;
          /** items to screen during check-pending (default 256) */
          'check-pending-items'?: number;
          ...
          /** when enabled, messages with dead consumer will be re-inserted into the stream (default true) */
          'enable-reproduce'?: boolean;
          /** timeout after which consumer is considered inactive if heartbeat wasn't performed (default 5m0s) */
  ...
  'persistent'?: {
    ...
    'pebble'?: {
      'experimental'?: {
        ...
        /** if true same target-file-size will be uses for all levels, otherwise target size for layer n = 2 * target size for layer n - 1 (default true) */
      ...
      /** maximum number of concurrent compactions (default 10) */
